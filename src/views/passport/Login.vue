<template>
    <el-form ref="form" action="javascript:void(0);" @keyup.enter.native="submitForm" :model="form" :rules="rules" label-position="top">
        ...
        <el-form-item>
            <el-button class="dk-btn-block" type="primary" @click="submitForm" :loading="formLoading">登 录</el-button>
        </el-form-item>
        <el-form-item class="dk-form-item-text dk-passport-other-login">
